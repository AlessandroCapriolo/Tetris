...
namespace graphicsNS
{
	...
	const COLOR_ARGB ALPHA90 = D3DCOLOR_ARGB(230, 255, 255, 255);  // AND with color to get 90% alpha
	const COLOR_ARGB ALPHA95 = D3DCOLOR_ARGB(242,255,255,255);  // AND with color to get 95% alpha
